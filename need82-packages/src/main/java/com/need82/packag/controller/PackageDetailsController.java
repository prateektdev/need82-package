...
//	public PackageModel getPackageDetailsById(@PathVariable(value = "id") Long packageId) {
//		return packageDetailsRepository.findById(packageId)
//				.orElseThrow(() -> new ResourceNotFoundException("Package", "id", packageId));
//	}

//	@PutMapping("/packages/{id}")
//	public BaseResponse updatePackageDetails(@PathVariable(value = "id") Long packageId,
//			@Valid @RequestBody PackageModel packageDetails) {
//
//		PackageModel packageModel = packageDetailsRepository.findById(packageId)
//				.orElseThrow(() -> new ResourceNotFoundException("Package", "id", packageId));
//
...
//				.orElseThrow(() -> new ResourceNotFoundException("Package", "id", packageId));
//
//		packageDetailsRepository.delete(packageModel);
//
